// lib/names_of_allah_screen.dart
...
class NamesOfAllahScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      // Uses the theme color (White in Dark Mode, Black in Light Mode)
                  ...
                  Text(
                    ...
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: AppTheme.primaryGreen, // Green is visible on both
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      // FIX: Changed from hardcoded Grey to a dynamic caption color
  ...
  // COMPLETE LIST OF 99 NAMES
  static const List<Map<String, String>> _names = [
    {"arabic": "الرَّحْمَنُ", "transliteration": "Ar-Rahman", "meaning": "The Entirely Merciful"},
    {"arabic": "الرَّحِيمُ", "transliteration": "Ar-Rahim", "meaning": "The Especially Merciful"},
    {"arabic": "الْمَلِكُ", "transliteration": "Al-Malik", "meaning": "The King"},
    {"arabic": "الْقُدُّوسُ", "transliteration": "Al-Quddus", "meaning": "The Pure One"},
    {"arabic": "السَّلاَمُ", "transliteration": "As-Salam", "meaning": "The Source of Peace"},
    {"arabic": "الْمُؤْمِنُ", "transliteration": "Al-Mu'min", "meaning": "The Inspirer of Faith"},
    {"arabic": "الْمُهَيْمِنُ", "transliteration": "Al-Muhaymin", "meaning": "The Guardian"},
    {"arabic": "الْعَزِيزُ", "transliteration": "Al-Aziz", "meaning": "The All Mighty"},
    ...
    {"arabic": "الْغَفُور", "transliteration": "Al-Ghafur", "meaning": "The Great Forgiver"},
    ...
    {"arabic": "الْقَوِيُ", "transliteration": "Al-Qawiyy", "meaning": "The Strong"},
    {"arabic": "الْمَتِينُ", "transliteration": "Al-Matin", "meaning": "The Firm"},
    {"arabic": "الْوَلِيُّ", "transliteration": "Al-Wali", "meaning": "The Friend"},
    ...
    {"arabic": "الْواحِدُ", "transliteration": "Al-Wahid", "meaning": "The One"},
    ...
    {"arabic": "مَالِكُ الْمُلْكِ", "transliteration": "Malik-ul-Mulk", "meaning": "The Eternal Owner of Sovereignty"},
    {"arabic": "ذُوالْجَلاَلِ وَالإكْرَامِ", "transliteration": "Dhul-Jalali wal-Ikram", "meaning": "The Lord of Majesty and Bounty"},
    ...
    {"arabic": "الضَّارَّ", "transliteration": "Ad-Darr", "meaning": "The Distressor"},
    ...
    {"arabic": "الْوَارِثُ", "transliteration": "Al-Warith", "meaning": "The Supreme Inheritor"},
